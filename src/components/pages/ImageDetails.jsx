...
const ImageDetails = () => {
  ...
  useEffect(() => {
    fetch(
      `http://images-api.nasa.gov/search?q=Herschel%20Space%20Observatory&media_type=image&nasa_id=${imageId}`
    )
      ...
      <main className="container">
        <section className="section detail">
            ...
            <figure className="main__img">
                <a href="#"><img src={image?.links?.[0]?.href} alt="이미지1" /></a>
            </figure>
            ...
            <div className="detail__info">
                <li><span>ID : </span><span>{image?.data?.[0].nasa_id}</span></li>
                <li><span>CREATOR : </span><span>{image?.data?.[0].secondary_creator}</span></li>
                <li><span>DATE : </span><span>{image?.data?.[0].date_created}</span></li>
            </div>
            </div>
        </section>
      </main>
